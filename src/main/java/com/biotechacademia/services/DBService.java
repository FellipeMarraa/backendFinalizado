...
public class DBService {
    ...
    public void instantiateTestDataBase() throws ParseException {
		...
		//ALONGAMENTOS
		Exercicio ex1 = new Exercicio(null, "Alongamento", "Alongamentos são exercícios voltados para o aumento da flexibilidade muscular, que promovem o estiramento das fibras musculares");
		
		//EXERCICIOS ABDOMINAIS
		Exercicio ex2 = new Exercicio(null, "Elevação de Pernas","Deite-se de barriga para cima no colchonete com as pernas estendidas e um calcanhar em cima do topo do outro pé.");
		Exercicio ex3 = new Exercicio(null, "Frontal", "Deite de costas no chão ou em um tapete, com os joelhos dobrados e as mãos atrás da cabeça.");
		Exercicio ex4 = new Exercicio(null,"Bike","De fácil execução, este exercício é realizado deitado no chão e requer uma boa coordenação motora.");
		Exercicio ex5 = new Exercicio(null, "Com inversão", "Deite de costas no chão ou tapete, com os joelhos dobrados e as mãos atrás da cabeça.");
		
		//EXERCICIOS DE BICEPS
		Exercicio ex6 = new Exercicio(null,"Rosca Inversa", "De pé, segurar a barra com as mãos com a pegada pronada.");
		Exercicio ex7 = new Exercicio(null,"Rosca Concentrada", "Segure o halter com a palma da mão voltada para cima (posição supinada).");
		Exercicio ex8 = new Exercicio(null,"Rosca Martelo", "Segure um halter em cada mão com os cotovelos estendidos e bem próximos aos lados do tronco.");
		Exercicio ex9 = new Exercicio(null,"Rosca Direta","Em pé, mantenha os pés afastados na largura do quadril e os joelhos levemente flexionados.");
		Exercicio ex10 = new Exercicio(null,"Rosca Alternada", "Fique em pé, com os pés ligeiramente afastados, joelhos levemente flexionados, e abdominal contraído.");
